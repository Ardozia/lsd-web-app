  ...
  <div class='container'>
    ...
    <div class="row">
      <div class="col-12 col-lg-6">
        ...
        <p class="fs-6"></p>
        <div>
          <a href="./upsertProduct.php" class="btn btn-primary mb-3"><i class="bi bi-plus-circle"></i>Nova</a>
          <table class="table">
            <thead>
              <tr>
            ...
            <tbody>
              ...
              foreach ($result as $row) {
                ...
                echo "  <td class='text-nowrap'><a class='me-1 btn btn-outline-primary' href='./upsertProduct.php?id=$id'><i class='bi bi-pencil-square'></i></a> ";
                echo " <button type='button' class='btn btn-outline-danger' data-bs-toggle='popover' data-bs-title='Eliminar categoria?' data-bs-html='true' data-bs-content=\"<a href='#' class='btn btn-secondary btn-sm me-2 popover-cancel'>Cancelar</a><a href='./deleteProduct.php?id=$id' class='btn btn-danger btn-sm'>Eliminar</a>\"><i class='bi bi-trash'></i></button></td>";
